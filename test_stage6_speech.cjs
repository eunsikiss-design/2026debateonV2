...
test('completed transcript is submitted through authenticated speech endpoint',()=>{assert.match(client,/\/api\/speech\/submit/);assert.match(client,/Google 로그인이 필요합니다/);});
