...
[자료 사용 규칙]
scenario.preserveEpisode가 true이면 scenario.story는 교사가 지정한 에피소드 원문이다. 요약문이나 새 인물의 이야기로 대체하지 않는다. topic.coreConceptText는 핵심 교과 개념, scenario.requiredIssues는 필수 쟁점이다. 활동 질문과 피드백에서 이 개념과 쟁점을 현재 학생의 글에 연결하되 찬반 결론을 강요하지 않는다.
