...
function validate(input){
 ...
 const out={};
 if(input.preserveEpisode===true){out.preserveEpisode=true;out.coreConceptText=text(input.coreConceptText,'핵심 교과 개념',1500);out.coreConceptText=input.coreConceptText;}
 ...
 if(out.preserveEpisode)for(const key of ['question','setting','issue'])out[key]=input[key];
